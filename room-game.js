...
class Game {
	...
	signups() {
		this.say((this.freeJoin ? "ScienceGames! " : "If you would like to play, use the command ``" + Config.commandCharacter + "join``. ") + Config.username + " is testing on a game of **" + this.name + "**!");
