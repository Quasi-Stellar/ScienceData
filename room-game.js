...
class Game {
	...
	signups() {
		this.say("ScienceData is testing on a game of **" + this.name + "**! " + (this.freeJoin ? "ScienceGames" : "If you would like to play, use the command ``" + Config.commandCharacter + "join``."));
